...
files.sort()
print(files)
#files = ['Structural Versions/theIndicator01.xml', 'Structural Versions/theIndicator02.xml', 'Structural Versions/theIndicator04.xml', 'Structural Versions/theIndicator05.xml', 'Structural Versions/theIndicator06.xml', 'Structural Versions/theIndicator07.xml', 'Structural Versions/theIndicator09.xml', 'Structural Versions/theIndicator10.xml', 'Structural Versions/theIndicator11.xml', 'Structural Versions/theIndicator12.xml', 'Structural Versions/theIndicator20.xml', 'Structural Versions/theIndicator21.xml', 'Structural Versions/theIndicator22.xml', 'Structural Versions/theIndicator23.xml', 'Structural Versions/theIndicator24.xml', 'Structural Versions/theIndicator25.xml', 'Structural Versions/theIndicator26.xml', 'Structural Versions/theIndicator27.xml', 'Structural Versions/theIndicator28.xml', 'Structural Versions/theIndicator29.xml', 'Structural Versions/theIndicator39.xml', 'Structural Versions/theIndicator40.xml', 'Structural Versions/theIndicator41.xml', 'Structural Versions/theIndicator42.xml', 'Structural Versions/theIndicator43.xml', 'Structural Versions/theIndicator44.xml']
result = {} 
                                ...
                                if e.find("./*") is None:
                                    ...
                                    for e in div.findall(".//{http://www.tei-c.org/ns/1.0}title"):
                                        ...
                                        if altstring is not None and altstring != "" and altstring not in result[file][section][subsect]["title"]:
                                            result[file][section][subsect]["title"].append(altstring)
                                        if string is not None and string != "" and string not in result[file][section][subsect]["title"]:
                                            result[file][section][subsect]["title"].append(string)                        
